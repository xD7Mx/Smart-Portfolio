          ...
          {mode === "news" ? (
            ...
            <>
              ...
              {/* شعارُ تداول مكانَ رمز الطور (بأمر المالك). والطورُ باقٍ في
                  ...
                  حاملُها. */}
              {/* ══ الكلمةُ العربيةُ وحدَها، ومحاذاتُها إلى الرقم ══
                  (بأمر المالك · D203)
                  حُذفت «Tadawul» فلم يبقَ «منتصفُ كلمتين» يُحاذى إليه، بل
                  كلمةٌ واحدة. والرمزُ يمتدّ تحتها فيجرّ مركزَ الصندوق —
                  فالمحاذاةُ إلى **الكلمة** لا إلى الصندوق. قِيس في المتصفّح:
                  مركزُ الكلمة 11.37 وحبرُ الرقم 16، فأُنزل الشعارُ بالفرق. */}
              <span style={{ display: "inline-flex", transform: "translateY(1.53px)" }}>
                <TadawulLogo height={15} wordColor="#ffffff" title={stateText} latin={false} />
              </span>
