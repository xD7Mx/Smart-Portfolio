          ...
          {mode === "news" ? (
            ...
            <>
              ...
              {/* شعارُ تداول مكانَ رمز الطور (بأمر المالك). والطورُ باقٍ في
                  ...
                  حاملُها. */}
              {/* ══ الرمزُ وحدَه ══ (بأمر المالك · D204)
                  جُرّبت الكلمةُ معه — كاملةً ثم عربيةً وحدَها — فردّها
                  المالكُ بعد رؤيتها على الشاشة. والرمزُ مربّعُ النسبة،
                  فمركزُ صندوقه مركزُ حبره: يحاذي الرقمَ بلا إزاحة. */}
