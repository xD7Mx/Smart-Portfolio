  ...
  return (
    <div className="live-clock relative flex items-center shrink-0 select-none">
      ...
      >
        ...
        {/* وسببُ الحالة يُقرأ بضغطةٍ لا بتحويمٍ (‏D413): كان في `title`
            وحدَه، والتحويمُ لا وجودَ له على الجوال — فالسببُ مخفيٌّ عن
            أكثر الاستعمال. وهذا موضعُه: نافذةٌ لا تُفتح إلا بقصد، فليس
            حاشيةً أسفل شاشة. ويُعرض حين يخالف المصدرُ التقويمَ — أي
            يومَ عطلةٍ أو إغلاقٍ طارئ — فلا يُثقَل اليومُ العاديّ بسطرٍ
            لا يضيف. */}
        {statusWhy && (
          <p className="text-[11px] leading-snug text-[var(--ink-muted)] mb-2.5">
            {statusWhy}
          </p>
        )}
