/* تبويبُ «صفقات خاصة» — مصدرُه «أرقام» بأمر المالك (D288).
 *
 * الصفقةُ الخاصة متفاوَضٌ عليها خارجَ دفتر الأوامر، بحجمٍ كبيرٍ وسعرٍ قد
 * يخالف سعرَ السوق — ولا تُقرأ من شريط الأسعار. وكثيراً ما تسبق تغيّرَ
 * ملكيةٍ مؤثّرة، فهي إشارةٌ تخصّ المالك لا زينةٌ في شاشة.
 *
 * والغيابُ يُقال: يومٌ بلا صفقاتٍ خاصّةٍ **وارد**، فتظهر جملةٌ واحدةٌ
 * صريحة — لا يُطوى التبويبُ فيُظنّ أنه لم يُبنَ، ولا يُعرض صفرٌ مختلَق.
 */
  ...
  return (
    <div className="card">
      <div className="flex items-center gap-2 mb-4">
        ...
        {data?.source && (
          <span className="tag-v ms-auto">{data.source}</span>
        )}
      </div>
