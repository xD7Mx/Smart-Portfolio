...
# ══ سقفُ التغطية الممكن — لا يُعاقَب أحدٌ على نقصٍ عندنا ══
#
# قِيس على السوق كلِّه بعد إصلاح المحلِّل: وسيطُ التغطية ‎0.50، ولا شركةَ
# واحدة فوق ‎75 من ‎386، ونصفُها تحت ‎42. والسببُ رياضيّ لا تقديريّ:
# الانكماشُ نحو الخمسين بجذر التغطية يقيس التغطيةَ منسوبةً إلى **واحدٍ
# صحيح** — أي إلى إفصاحٍ كامل لكلّ مؤشّرات البطاقة. وذلك مقياسٌ لا تبلغه
# شركةٌ في هذا السوق، لا لتقصيرها بل لأن مصدرَنا لا يوفّر بعضَ الأركان
# لأحد: تكلفةُ المخاطر للبنوك، والعائدُ التوزيعيّ للريت، وأمثالُها.
#
# فكانت الدرجةُ تُخصم من الجميع بالقدر نفسه — وخصمٌ متساوٍ على الكلّ لا
# يضيف معلومةً، بل يسحق المدى ويمحو التمييز: شركةٌ خامٌ ‎80 عند تغطية
# ‎0.45 تخرج ‎70، فيستحيل بلوغُ «ممتاز» على أحد.
#
# والصوابُ أن تُنسب التغطيةُ إلى **ما يمكن بلوغه** لهذا النمط من مصدرنا،
# لا إلى كمالٍ نظريّ. فمن أفصح بكلّ ما يمكن الحصولُ عليه لا يُعاقَب،
# ومن أفصح دون أقرانه يُعاقَب — وهو معنى «غيابُ الدليل ليس دليلَ سلامة»
# على وجهه الصحيح.
#
# والأرقامُ أدناه **مقيسة لا مقدَّرة**: تُحسب بتمرير قوائمَ كاملةِ البنود
# على خطّ السمات لكلّ نمط، ثم تُقرأ نسبةُ الوزن الذي أمكن حسابُه.
# يُعيد قياسَها `scripts/audit/attainable.py`، ويطبع `calibration.py`
# وسيطَ التغطية الفعليّ ليُقارَن بها.
ATTAINABLE = {
    "asset_light": 1.00,
    "bank": 0.65,
    "capital_infra": 0.75,
    "commodity": 0.95,
    "consumer_cyclical": 1.00,
    "consumer_defensive": 1.00,
    "contracting": 0.85,
    "financial": 0.50,
    "insurance": 1.00,
    "re_developer": 0.85,
