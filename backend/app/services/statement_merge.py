...
#
# ══ وقُضي بمبدأٍ أعلى: لا إعفاءَ لمُصدِرٍ مُلزَمٍ بالإفصاح ══ (D370)
#
# قضى المالك: «جميعُ الشركات الرئيسية في السوق ملزمةٌ بالإفصاح أيّاً كان
# قطاعُها، فلا يوجد امتناعٌ مفهوم». والمبدأُ يكشف خلطاً في السطور التي
# كانت هنا: صحيحٌ أن البنكَ لا ينشر سطراً اسمُه «تكلفةُ تمويل»، لكنه
# **ينشر «مصروفَ العمولات الخاصّة»** — وهو البندُ نفسُه باسمِ صناعته.
# والريتُ ينشر «إضافاتٍ على العقارات الاستثمارية» — وهي النفقةُ
# الرأسمالية بلغته. فالبندُ **مُفصَحٌ عنه**، وعجزُنا كان في **الخريطة**
# لا في السوق. فحوّلتُ عجزي إعفاءً، وهو ما مُنعتُ منه.
#
# فأُلغي الإعفاءُ عن كلّ صنفٍ يُصدِر قوائمَ، ويُستعاض عنه بنقلِ أسماء
# المكافئات **بالحرف** من ملفّاتٍ حقيقيةٍ (‏`xbrl_labels.py --sectors`)
# كما نُقلت الثلاثةُ التي استخرجت ‎47.5 مليار دَينٍ في ورقةٍ واحدة. وحتى
# يُنقَل الاسمُ يبقى البندُ **ناقصاً معلَناً** — لأن «ناقصاً» صدقٌ
# و«غيرَ ذي معنى» دعوى.
#
# ويبقى صنفٌ واحدٌ ليس مُصدِراً بهذا المعنى: **الورقةُ المؤشِّرة/الصندوق
# المتداول** — إفصاحُها صافي أصولٍ يوميٌّ لا قائمةَ دخلٍ ربعية، فلا
# مصدرَ في الدنيا يملك لها هذه البنود. وهو معروضٌ على المالك صريحاً.
