...
async def analyze_company(symbol: str, name: str | None = None, db=None, allow_supplement: bool = True) -> Optional[dict]:
    ...
    # ══ الإسنادُ جُرِّب فسقط بالقياس ══ (D175)
    # جُعل تقديرُ التطبيق سنداً يملأ ما لا يغطّيه المحلّلون، فارتفعت
    # التغطيةُ من ‎١٤٩ إلى ‎٢١٣ من ‎٢٧٣. ثمّ قِيس التقديرُ على ‎١٢٠ شركةً
    # يوجد لها هدفُ محلّلين — أي حيث نملك مرجعاً نقيس عليه:
    #
    #   وسيطُ الانحراف ‎٤٤٪ · ضمن ‎±٢٥٪ ‎٢٦٪ فقط · المئينيّ التسعون ‎٨٢٪
    #
    # وكان الشرطُ المعلَن قبل القياس: وسيطٌ ‎≤٢٥٪ و‎≥٦٠٪ ضمن ‎±٢٥٪.
    #
    # والأخطرُ ليس الانحرافَ بل شكلَه: سبعٌ من أسوأ عشرٍ **تنهار إلى
    # الصفر** — ‎0.07 ريالٍ لورقةٍ هدفُها ‎35، و‎0.56 لِـ‎23.50، و‎1.45
    # لِـ‎32.04. وذلك عطبُ حسابٍ لا اختلافُ رأي: تقديرٌ مدفوعٌ بالأرباح
    # بلا أرضيةٍ من الأصول ينهار حين تنضغط الأرباح.
    #
    # فرُدَّ الإسناد. «السعر العادل» هدفُ بيوت الخبرة وحدَه كما أمر
    # المالك، وما لا يصله هدفٌ يبقى «غير متوفّر» — والصمتُ أصدقُ من رقمٍ
    # قد يكون ‎0.07 وهو ‎35. ويعود الإسنادُ متى عولج الانهيارُ وقِيس.
