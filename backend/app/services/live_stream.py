...
# وصار خمساً بأمر المالك: «الحركةُ المتّصلةُ أريدها بالثواني» (D329).
# فسؤالُ المصدر كلَّ خمسِ ثوانٍ = اثنتا عشرةَ نداءةً في الدقيقة (لا مئةٌ
# وسبعون كما كان)، فتصل الدفعاتُ أقربَ فتُوزَّع على ثوانٍ متّصلة.
SOURCE_POLL = 5.0
