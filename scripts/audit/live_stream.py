...
# ══ والطورُ يبقى مثبَّتاً إلى آخر الحارس ══ (D340)
# كان يُعاد الطورُ الحقيقيُّ هنا، والقسمُ ١٢ بعدَه يقيس **الدفعَ** —
# والمضخّةُ لا تدفع والسوقُ مغلق. فكان ١٢ب و١٢ج يخضرّان في ساعات
# التداول ويحمرّان بعدها: حارسٌ يقيس ساعةَ التشغيل لا الشفرة، وهو
# منهيٌّ عنه في الميثاق. والقسمُ ١٢ آخرُ الأقسام فلا حاجةَ للإعادة.
_MP.market_phase = lambda *a, **k: "open"                        # type: ignore[assignment]
