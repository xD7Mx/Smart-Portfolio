...
# هذا السكربتُ يشغّل المحرّكَ على عشيرةٍ كاملة، والمحرّكُ يحفظ ما يقرؤه
# في `lastgood` — فكان يلوّث ملفَّ تشغيلٍ متتبَّعاً في المستودع ويمنع
# بناءَ الحزمة. وسكربتُ فحصٍ يغيّر حالةً ليس فحصاً. فيُوجَّه إلى مجلّدٍ
# مؤقّت **قبل أيّ استيراد** — الوحداتُ تقرأ المسارَ عند تحميلها.
