...
python3 scripts/audit/dividends_official.py || _note "$LINENO"
python3 scripts/audit/audit_shares_unit.py || _note "$LINENO"
python3 scripts/audit/sector_method_applied.py || _note "$LINENO"
...
python3 scripts/audit/screener_fv_from_store.py || _note "$LINENO"
node scripts/audit/d7m_logic.mjs || _note "$LINENO"
python3 scripts/audit/saudi_weekly_sunday.py || _note "$LINENO"
...
python3 scripts/audit/closed_positions_d480.py || _note "$LINENO"
python3 scripts/audit/tx_audit_d481.py || _note "$LINENO"
python3 scripts/audit/tx_invariants_d482.py || _note "$LINENO"
python3 scripts/audit/broker_reconcile_d483.py || _note "$LINENO"
python3 scripts/audit/cash_statement_d484.py || _note "$LINENO"
python3 scripts/audit/stock_page_d485.py || _note "$LINENO"
python3 scripts/audit/etf_nomu_d486.py || _note "$LINENO"
python3 scripts/audit/ebitda_d489.py || _note "$LINENO"
python3 scripts/audit/report_bidi_d479.py || _note "$LINENO"
