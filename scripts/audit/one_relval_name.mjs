// ─────────────────────────────────────────────────────────────────────────
// D235 — اسمٌ واحدٌ للتقييم النسبيّ في كلّ شاشة.
//
...
const RETIRED = ["القيمة النسبية إلى القطاع", "قيمة نسبية إلى القطاع",
                 "نسبية للقطاع", "القيمة النسبية للسهم"];
...
say(/"basis": "التقييم النسبي"/.test(eng),
...
say(panel.includes('<div className="kpi-lbl">التقييم النسبي</div>'),
