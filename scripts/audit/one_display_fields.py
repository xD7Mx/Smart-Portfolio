...
check("price_to_book" in d3b and d3b["price_to_book"] is None,
      "٣ب وبلا منشورٍ ولا مقياسٍ تُكتب None — لا رقمَ من سعرٍ آخر",
      f"{d3b.get('price_to_book')} (المفتاحُ مكتوب)")
