...
// ══ العدُّ ليس هو الحارس ══ (D208)
// كان يشترط عرضَ الميزان في شاشتين على الأقلّ، فلمّا أمر المالكُ بحذفه من
// تبويب التقييم سقط الفحصُ على تنفيذٍ صحيح. وعددُ الشاشات قرارُ مالكٍ لا
// عطبٌ هندسيّ؛ والذي يُحرَس أن التعريفَ واحدٌ وأن كلَّ عارضٍ يستدعيه.
say(true, "١ عددُ الشاشات العارضة قرارُ مالكٍ لا شرطُ فحص",
    users.length ? users.join(" · ") : "لا شاشةَ تعرضه اليوم");
