...
# ══ العلاقةُ انقلبت بالقياس ══ (D327)
# كان الشرطُ «ذاكرةُ المؤشّر ≤ نبضِ الشاشة»، وهو مبنيٌّ على اعتقادٍ أن
# المصدرَ ينشر كلَّ ثانية. وقِيس على خادم المالك أنّ بابَ المؤشّر يقول
# `max-age=60` وقيمتُه تتغيّر كلَّ ~ستّين ثانية — فسؤالُ المصدر أسرعَ من
# نشره إغراقٌ لا لحظية. فالعقدُ الصحيحُ حدّان:
#   · ذاكرةُ المؤشّر **لا تتجاوز إيقاعَ نشره** (وإلا ضاعت نشرة)
#   · ونبضُ الشاشة **لا يتجاوز الذاكرة** (وإلا بقي الرقمُ في المخزن
#     لا يراه أحد)
SRC_CADENCE = 60          # ثانيةً — مقيسٌ لا مفترَض (D327)
check(M.INDEX_TTL <= SRC_CADENCE,
      "٥ب وذاكرةُ المؤشّر لا تتجاوز إيقاعَ نشره — وإلا ضاعت نشرة",
      f"{M.INDEX_TTL}ث لبابٍ ينشر كلَّ {SRC_CADENCE}ث")
check(open_ms / 1000 <= M.INDEX_TTL,
      "٥ج ونبضُ الشاشة لا يتجاوز الذاكرة — وإلا بقي الجديدُ لا يُقرأ",
      f"{open_ms}ms مقابل ذاكرةٍ {M.INDEX_TTL}ث")
