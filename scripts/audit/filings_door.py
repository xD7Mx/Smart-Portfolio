...
## البواباتُ الخمس كما هي في الشفرة
  ...
  ٥· تُجيب ولا رابطَ فيها إلى `XBRL_DOCS` ← أي أن الشركةَ **لم تودع**
     ملفّاً فعلاً، وهذا الوحيدُ الذي يُقال فيه «بلا ملفّات» بحقّ.
...
async def main() -> int:
    ...
    print("\nالحكم: البوّابةُ ٥ وحدَها هي «بلا ملفّاتٍ» بحقّ — شركةٌ لم"
          " تودع. وما فوقها عطبٌ عندنا: بوّابةٌ ٣ تعني اسمَ خدمةٍ آخرَ"
