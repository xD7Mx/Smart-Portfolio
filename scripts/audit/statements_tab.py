...
## والقياسُ تمّ — والبابُ مغلَقٌ بأرقامه (‏D368)

عيّنةٌ موزَّعةٌ بالبادئة (‏24 من 82) على خادم المالك ‎2026-09-16:

  • **فيه أرقامٌ: 8 · بلا أرقام: 16** — أي ثُلثُ التغطية لا كلُّها.
  • **أحدثُ تاريخٍ في العيّنة كلِّها: 2023-09-19** — ثلاثُ سنواتٍ.
    وأقدمُ «أحدثِ تاريخ»: ‎2022-08-30 — أربعُ سنوات.
  • و`statementType=3` (‏ربحيةُ السهم · القيمةُ الدفترية · ROE) يردّ
    **شُرَطاً لكلّ ورقةٍ قِسناها**، حتى ‎2220 التي ردّت قائمتَي دخلٍ
    وتدفّقٍ كاملتَين — فحتى المتاحُ مبتورٌ من نسبِه.

فلا طبقةَ تُبنى من هذا الباب: ثُلثُ تغطيةٍ بأرقامِ ثلاثِ سنواتٍ
ليس «قوائمَ مالية»، و`MAX_AGE_DAYS = 200` كان محقّاً يوم رفضه.
وأحدثُ أرقامِ الـ82 تبقى من «أرقام» و‎Yahoo، ويُقال ذلك صريحاً.
ولا يُطرَق هذا البابُ سادسةً.
"""
